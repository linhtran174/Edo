...
<link rel="stylesheet"
    href=<?php echo base_url("assets/css/teacher-login.css")?> type="text/css" />
<link rel="stylesheet"
...
<body>
    ...
    <div style="text-align: center;">
        <p>Bạn chưa có tài khoản? <a href="<?php echo site_url("teacher_controller/register")?>"">Đăng ký nhanh</a></p>
    </div>
